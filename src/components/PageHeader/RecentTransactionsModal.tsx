...
import { CheckmarkCircleIcon, ErrorIcon, Flex, LinkExternal, Text, Modal } from '@artechain/uikit'
import { useActiveWeb3React } from 'hooks'
import { getBscScanLink } from 'utils'
import { isTransactionRecent, useAllTransactions } from 'state/transactions/hooks'
import { TransactionDetails } from 'state/transactions/reducer'
import Loader from 'components/Loader'
import { WrapperModal, ButtonArt as Button } from 'components/Art'
      ...
      <Modal title="Recent Transactions" onDismiss={onDismiss}>
        {!account && (
          <Flex justifyContent="center" flexDirection="column" alignItems="center">
            <Text mb="16px" fontWeight='600' fontSize='14px' color='#808982'>
              Please connect your wallet to view your recent transactions
            </Text>
            <Button className='full-with' variant="tertiary" size="sm" onClick={onDismiss}>
              Close
            </Button>
          </Flex>
        )}
