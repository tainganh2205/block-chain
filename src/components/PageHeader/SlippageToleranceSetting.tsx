...
import { ButtonArt as Button, InputArt as Input } from 'components/Art'
  ...
  return (
    <StyledSlippageToleranceSettings>
      ...
      <Options>
          ...
          {predefinedValues.map(({ label, value: predefinedValue }) => {
            ...
            return (
              <Option key={predefinedValue}>
                ...
                <Button height="32px" data-variant={value === predefinedValue ? 'primary' : 'tertiary'} onClick={handleClick}>
                {label}
                </Button>
        ...
        <Flex mb={['8px', 10]} alignItems="center">
          <Option>
            <Input
              type="number"
              scale="sm"
