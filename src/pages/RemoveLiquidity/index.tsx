...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@lfwfinance/sdk-dev'
import { Flex, Heading, Text } from '@artechain/uikit'
import { ArrowDown, Plus } from 'react-feather'
import { RouteComponentProps } from 'react-router'
import CardNav from 'components/CardNav'
import { WrapperContainer, ButtonArt as Button,ButtonYelArt as ButtonYel, WrapperHeaderArticle, WrapperPage } from 'components/Art'
...
export default function RemoveLiquidity({
  ...
  return (
    <PageWrapper className="full-with PageWrapper">
          ...
          <AutoColumn gap="md">
            <Body>
              <OutlineCard>
                <AutoColumn>
                  <RowBetween>
                    <Text className='cl-gray sz-14'>Amount</Text>
                    <ClickableText
                     className='cl-gray sz-14'
                      onClick={() => {
                  ...
                  <Flex justifyContent="start">
                    <Text fontSize="30px">{formattedAmounts[Field.LIQUIDITY_PERCENT]}%</Text>
                  </Flex>
                  {!showDetailed && (
                    <>
                      <Flex mb="8px">
                      ...
                      <Flex justifyContent="space-around">
                        <ButtonYel scale="sm" variant="tertiary" data-variant="tertiary" size="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '25')}>
                          25%
                        </ButtonYel>
                        <ButtonYel scale="sm" variant="tertiary" data-variant="tertiary" size="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '50')}>
                          50%
                        </ButtonYel>
                        <ButtonYel scale="sm" variant="tertiary" data-variant="tertiary" size="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '75')}>
                          75%
                        </ButtonYel>
                        <ButtonYel
                          scale="sm"
              ...
              <>
                ...
                <Body>
                  <OutlineCard>
                    <AutoColumn gap="10px">
                      <RowBetween>
                        <Text fontSize="24px" className='cl-white fw-bold'>{formattedAmounts[Field.CURRENCY_A] || '-'}</Text>
                        <RowFixed>
                          <CurrencyLogo currency={currencyA} style={{ marginRight: '12px' }} />
                          <Text fontSize="24px" id="remove-liquidity-tokena-symbol" className='cl-white fw-bold'>
                            {currencyA?.symbol}
                          </Text>
                        </RowFixed>
                      </RowBetween>
                      <RowBetween>
                        <Text fontSize="24px" className='cl-white fw-bold'>{formattedAmounts[Field.CURRENCY_B] || '-'}</Text>
                        <RowFixed>
                          <CurrencyLogo currency={currencyB} style={{ marginRight: '12px' }} />
                          <Text fontSize="24px" id="remove-liquidity-tokenb-symbol" className='cl-white fw-bold'>
                            {currencyB?.symbol}
                          </Text>
                        </RowFixed>
                      </RowBetween>
            ...
            <Body style={{ paddingBottom: '24px' }}>
              ...
              {pair ? (
                <AutoColumn style={{ minWidth: isMobile ? '100%' : '20rem', marginTop: '1rem' }}>
              ...
              {pair && (
                <div style={{padding: '24px 0'}}>
                  ...
                  >
                    ...
                    <div className='cl-white fw-bold'>
                      1 {currencyA?.symbol} = {tokenA ? pair?.priceOf(tokenA).toSignificant(6) : '-'} {currencyB?.symbol}
                    </div>
                  </Flex>
