...
const LeaderboardMobile = React.memo( (): any => {
        ...
        return (
          <div className="content-rounds-wrap">
              <div className="box-volume-filter">
                  <Radio.Group onChange={onChange} value={valueRadio} key={valueRadio}>
              ...
              <div className="box-tab-collapse">
                  ...
                  {theBest.map((item: any, index) => (
                    (tenVolum(item, index + 1, valueRadio * index + 400))
                  ))}
              </div>
          </div>
        )
    ...
    const ContentTopWiner = () => {
        return (
          <div className="content-rounds-wrap">
              ...
              <div className="box-tab-collapse">
                  {theBest.map((item: any, index) => (
                    (tenWinner(item,  index + 1, valueRadio * index + 300))
                  ))}
              </div>
          </div>
        )
