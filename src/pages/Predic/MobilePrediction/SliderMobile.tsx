...
import { Slider, Button, Progress, Tooltip, Modal } from 'antd'
...
const SliderContentLiveNow = ({ item, socketInfo }) => {
  ...
  return (
    <div className={isUp ? 'item-swiper-content live cus current' : 'item-swiper-content live  current'}>
      <div className="item-top">
        <div className="item-top-left">
          <div className="box-icon">
...
const SliderContentCalculating = ({ item }) => (
  <div className="item-swiper-content set-position calculating">
    <div className="item-top">
      <div className="item-top-left">
        <div className="box-icon">
  ...
  return (
    <div className="item-swiper-content cus live current before">
      ...
      <div className="item-body">
        <div className="box-trader-view">
          <div className="btn-down">
            <span className="price-btn"> {item.totalDown}x Payout</span> UP
            <div className="img-btn">
              <img src="/images/imagesPrediction/up-res-green.svg" alt="" />
            </div>
          </div>
        ...
        >
          <div className="content-modal-collect">
            ...
            <div className="collect-price">
              ...
              <p className="price">
                {item.bonus} BNB <span className="txt">{item.bonus * item.closedPrice}$</span>
              </p>
            </div>
            <button
              onClick={() =>
        ...
        {item.joinedStatus === 2 ? (
          <div className="box-colleting-win">
            ...
            <div className="text-collecting">
              <button type="button" onClick={showModal} className="btn-collecting">
                Collect Winnings
              </button>
            </div>
          </div>
...
const SliderMobile = React.forwardRef<RefObject, { socketInfo }>((props, ref) => {
  const socketInfo = props.socketInfo
  const [state, actions] = useHookPrediction()
  const refNext = React.useRef<RefSwiper>(null)
  const { account } = useActiveWeb3React()
