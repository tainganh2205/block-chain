import { CurrencyAmount, JSBI, Token, Trade } from '@lfwfinance/sdk-dev'
import React, { useCallback, useContext, useEffect, useMemo, useState } from 'react'
import { ArrowDown } from 'react-feather'
import { CardBody, IconButton, Text, Heading } from '@artechain/uikit'
...
import { WrapperHeaderArticle, WrapperPage, ButtonArt as Button } from 'components/Art'
import AppBody from '../AppBody'
import CurrencyInputBridgePanel from "../../components/CurrencyInputBridgePanel";
import './style.less'
  ...
  return (
    <PageWrapper className="full-with PageWrapper bg-main-wrapper">
      ...
      <WrapperHeaderArticle>
        <Heading as="h1" mb="16px" className="title">
          Easy to Swap at No Cost
        </Heading>
      ...
      <AppBody>
        ...
        <Wrapper id="swap-page">
          ...
          {/*             <RowBetween align="center"> */}
          {/*               <Text className="cl-white" fontSize="14px"> */}
          {/*                 Slippage Tolerance */}
          {/*               </Text> */}
          {/*               <Text className="cl-white" fontSize="14px"> */}
          {/*                 {allowedSlippage / 100}% */}
