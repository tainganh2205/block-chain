  ...
  return (
    <li key={`my-artwork-${item.id}`} className="c-list__item">
      ...
      <div className="c-list__img_usercenter">
        <a href={`/#/NFTdetail/${item.id}`} className="a-bsc">
          {item.fileType === 2 ? (
...
const List = ({ props }: any): any => {
  ...
  // const idArtistStr = idArtist.toString();
  // const idArtistStr = String(idArtist);
  ...
  const formikEdit = useFormik({
    ...
    onSubmit: () => {
        console.log('formik.values:', formikEdit.values)
        ...
        <div className="l-container c-productdetail">
          <div className="c-productdetail__title">
            ...
            <h3 className="text-white">
              <div className="row-flex row-flex-wrap">
                {objData === undefined ? (
                  <h3 className="text-white">Artist: N/A</h3>
                ) : (
          ...
          <div className="row-padding">
            {objData === undefined ? (
              ...
              <a href="/#/mintNFT" type="button" className="mint-nft">
                Mint NFT
              </a>
            )}
          </div>
