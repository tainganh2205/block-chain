...
const ModalDisClaimer = (props:any) => {
    ...
    console.log('data: ',dataDisClaimer )
    ...
    return (
        <>
            {/* <Button type="primary" onClick={showModal}>
              ...
              <Modal className="modal-disclaimer" destroyOnClose={true} title="Just A Sec!" onCancel={handleCancel} visible={state.isShowDisClaimer}>
                {contentModal}
            </Modal>
