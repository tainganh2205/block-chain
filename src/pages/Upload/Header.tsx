          ...
          <div className="labelName">
            <>
              {account === null ? (
                ...
                <a href="#/createArtists" className="btn-art-primary" data-variant='tertiary' style={{height: '50px', padding: '0px 24px', display: 'inline-flex', alignItems:'center', fontWeight:500}}>
                  {/* Create artists */}
                  Activate Profile
                </a>
              )}
