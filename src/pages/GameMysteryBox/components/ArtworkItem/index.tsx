...
const ItemArtwork = memo<ArtworkItemProps>((props) => {
  ...
  return (
            ...
            {(() => {
              switch (props.artwork?.status) {
                ...
                case STATUS_ARTWORK.PENDING:
                  return <img src="/images/peding.png" alt="..." />
                case STATUS_ARTWORK.REJECT:
                  return <img src="/images/reject.png" alt="..." />
                default:
                  return true
              }
            })()}
    ...
    {
      props.artwork.isGameBox === true
      ?
      (
        <div className="button-open-box">
          <button type='button'>Open Chest</button>
        </div>
      )
      : <></>
    }
