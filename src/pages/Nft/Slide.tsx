                            ...
                            <div className="c-slider__item">
                                ...
                                <div className="c-slider__cont">
                                    ...
                                    <div className="c-slider__text">
                                        <h3>Auction for the artworks you love</h3>
                                        <div className="c-slider__price">
                                            {/* <span>Vote</span> */}
                                            <div className="logo-center"><img className="set-height" src="/assets/images/icon01.svg" alt="" /></div>
                                        ...
                                        <p>The Leading Digital Artworks Marketplace</p>
                                    </div>
                                </div>
                            </div>
                        </SwiperSlide>
