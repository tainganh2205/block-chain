...
export interface NftInterface extends ethers.utils.Interface {
  functions: {
    "LFW_ADMIN()": FunctionFragment;
    "NFTIds(uint256)": FunctionFragment;
    "UserNFTIds(address)": FunctionFragment;
    ...
    "updateNftTokenIds(uint256[])": FunctionFragment;
    "whitelistAddress(address)": FunctionFragment;
  };

  encodeFunctionData(functionFragment: "LFW_ADMIN", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "NFTIds",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "UserNFTIds", values: [string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "LFW_ADMIN", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "NFTIds", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "UserNFTIds", data: BytesLike): Result;
  ...
  events: {
    ...
    "ClaimNFT(address,address,uint256)": EventFragment;
    "NewNftTokenIds(uint256[])": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "Transfer(address,address,uint256)": EventFragment;
    "WhitelistedUser(address[])": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "WhitelistedUser"): EventFragment;
}
...
export type WhitelistedUserEvent = TypedEvent<
  [string[]],
  { _addresses: string[] }
>;

export type WhitelistedUserEventFilter = TypedEventFilter<WhitelistedUserEvent>;
...
export interface Nft extends BaseContract {
  ...
  functions: {
    LFW_ADMIN(overrides?: CallOverrides): Promise<[string]>;

    NFTIds(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;

    UserNFTIds(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "ClaimNFT(address,address,uint256)"(
      user?: string | null,
    ...
    "WhitelistedUser(address[])"(_addresses?: null): WhitelistedUserEventFilter;
    WhitelistedUser(_addresses?: null): WhitelistedUserEventFilter;
  };

  estimateGas: {
    LFW_ADMIN(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    LFW_ADMIN(overrides?: CallOverrides): Promise<PopulatedTransaction>;
